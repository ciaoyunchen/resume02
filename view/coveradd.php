...
<form action="./api/coveradd.php" method="post" enctype="multipart/form-data" style="width:60%; margin:auto">
    <table>
        <tr>
            <td>Cover image:</td>
        ...
        <tr>
            <td>Cover text:</td>
            <td><input type="text" name="text" id="text" style="width:200px"></td>
        </tr>
        <tr>
